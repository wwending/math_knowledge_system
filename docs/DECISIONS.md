...
- 完整预检、launcher 参数、hotfix 与安全退役流程由 `docs/ENGINEERING_WORKFLOW.md` 定义；本决策不引入 daemon、持久队列/数据库、locking service、远程 runner、自动 merge 或自动清理。
...
日期：2026-08-20（V2 launcher 补充；原决策于 2026-08-19 建立）
