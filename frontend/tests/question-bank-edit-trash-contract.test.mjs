...
const loader = fs.readFileSync(new URL('../src/utils/questionImageLoader.js', import.meta.url), 'utf8')
...
for (const marker of ['const remove', 'generations', 'URL.revokeObjectURL', 'syncItems']) assert.ok(loader.includes(marker), `Image loader missing ${marker}`)
