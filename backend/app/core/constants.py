...
# Schema-v2 question document limits (#128).
QUESTION_MAX_FIGURES = 20
QUESTION_MAX_FIGURES_PER_IMAGE_AREA = 10
QUESTION_MAX_BLOCKS_PER_SECTION = 50
QUESTION_MAX_FIGURE_BYTES = 4 * 1024 * 1024
QUESTION_DOCUMENT_MIN_CROP_AREA_RATIO = 0.01
