...
- The local launcher may provision and start that Worker, but it must preserve the same branch/worktree ownership checks and fail-safe boundaries; orchestration is not permission to bypass isolation.
