...
- The local launcher may provision and start that Worker, but it must reject overlapping linked-worktree paths and hold an exclusive per-worktree process lease for the Worker's lifetime. Orchestration is not permission to bypass isolation.
