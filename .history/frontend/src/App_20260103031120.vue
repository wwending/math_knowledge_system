...
const smartLatexFix = (text) => {
  ...
  // 2. 打印原始数据到控制台 (方便你截图给我看)
  console.log('=== 百度原始 OCR 结果 ===')
  console.log(res)
...
/* Markdown 内容样式优化 */
.markdown-body {
  overflow: visible !important; /* 让 MathJax 公式能显示完整 */
...
/* 布局调整：让结果和知识点上下排列，不要挤在一起 */
.analysis-section {
  margin-top: 30px; /* 给知识点上方留出空间 */
